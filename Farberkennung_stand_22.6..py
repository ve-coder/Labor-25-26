...
#scan reihenfolge
#Die obere Seite zeigt zur Kamera. (U)
#Danach die rechte Seite zur Kamera drehen. (R)
#Danach die Vorderseite zur Kamera drehen. (F)
#Danach die Unterseite zur Kamera drehen. (D)
#Danach die linke Seite zur Kamera drehen. (L)
#Zum Schluss die Rückseite zur Kamera drehen. (B)
